        ...
        <>
            <div className={`turf_box ${props.list ? props.list : ''}`}>
                <div className="turfImage">
                    ...
                    {props.bookinglist ? "" : <a href="javascript:;" className="share-icon">
                ...
                <div className="turfDetails">
                    ...
                    {props.bookinglist ? <div className="rating-section">
                    ...
                    {props.bookinglist ? "" : <div className="gameIcons">
                        <div className="gameIcons-left-items">
                            <a className="gameIcons-item">
                                {/* <img className="img-fluid" src="turf1.jpg" alt="sport-icon" /> */}
                            </a>
                            <a className="gameIcons-item">
