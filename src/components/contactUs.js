                    ...
                    <Row className="align-items-center">
                        <Col md={6} sm={12}>
                            <div className="pe-5">
                                ...
                                <p className="subtext">The easiest way to get in touch with us is via phone or email.</p><br/>
                                <p className="subtext">Phone:</p>
                                <p className="subtext">tel:+911141185700</p><br/>
                                <p className="subtext">EMAIL:</p>
                                <p className="subtext">mailto:contact@hudle.in</p>
